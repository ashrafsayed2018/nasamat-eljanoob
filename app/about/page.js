...
export const metadata = {
  title: 'من نحن – رؤيتنا ومسيرتنا في مجال الطاقة',
  description:
    'تعرف على شركة نسمات الجنوب التجاريه: شركة وطنية رائدة متخصصة في توريد مواد الطاقة والكهرباء في المملكة العربية السعودية، رؤيتنا ورسالتنا وقيمنا.',
  alternates: {
    canonical: '/about',
  },
  openGraph: {
    title: 'من نحن – شركة نسمات الجنوب للطاقة',
    description:
      'شركة نسمات الجنوب التجاريه: شركة وطنية رائدة متخصصة في توريد مواد الطاقة والكهرباء في المملكة العربية السعودية.',
    url: '/about',
    images: [
      {
